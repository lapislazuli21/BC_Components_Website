    ...
    <>
      ...
      <main className="flex items-center text-dark dark:text-light w-full min-h-screen">
        <Layout className='py-2 px-8'>
          ...
          <div className='flex flex-row items-start justify-around text-center py-16 mt-2 my-8 bg-slate-300 rounded-lg sm:hidden'>
            ...
            <figure className='bg-secondary m-8'>
          ...
          {/*Mobile View*/}
          <div className='hidden sm:flex sm:flex-col sm:items-center sm:bg-slate-300 mb-6'>
            <div className='sm:p-4 sm:flex sm:flex-col sm:items-center'>
              <h1 className='sm:text-2xl sm:text-primary font-mono sm:font-semibold'>Who we are</h1>
              <h3 className='text-xl sm:text-base text-center py-2'>We cater to OEMs in <span className='font-semibold'>Power, Automation, Energy, Lighting, Instumentation</span> and many other industrial sectors.</h3>
            </div>
            <hr className='sm:border-secondary sm:w-1/2' />
            <div className='sm:p-4 sm:flex sm:flex-col sm:items-center'>
              <h1 className='sm:text-2xl sm:text-primary font-mono sm:font-semibold'>What we do</h1>
              <h3 className='text-xl sm:text-base text-center py-2'>We strive to provide the best experience to our customers, team, and principals. Their support has allowed us to become <span className='font-semibold'>one of the most value-added service providers</span> in the industry today. </h3>
            </div>
          </div>
        </Layout>
      </main>
